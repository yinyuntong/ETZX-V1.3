...
#define EXT_INT                  (*(volatile unsigned long *)0x400FC140)
#define EXT_MODE                 (*(volatile unsigned long *)0x400FC148)
#define EXT_POLAR                (*(volatile unsigned long *)0x400FC14C)
...
#define P_CON                    (*(volatile unsigned long *)0x400FC0C0)
#define P_CONP                   (*(volatile unsigned long *)0x400FC0C4)
...
#define CC_R                     (*((volatile unsigned long *)0xE000ED14))
...
*********************************************************************************************************/
#define PIN_SEL0                 (*((volatile unsigned long *)0x4002C000))
#define PIN_SEL1                 (*((volatile unsigned long *)0x4002C004))
#define PIN_SEL2                 (*((volatile unsigned long *)0x4002C008))
#define PIN_SEL3                 (*((volatile unsigned long *)0x4002C00C))
#define PIN_SEL4                 (*((volatile unsigned long *)0x4002C010))
#define PIN_SEL5                 (*((volatile unsigned long *)0x4002C014))
#define PIN_SEL6                 (*((volatile unsigned long *)0x4002C018))
#define PIN_SEL7                 (*((volatile unsigned long *)0x4002C01C))
#define PIN_SEL8                 (*((volatile unsigned long *)0x4002C020))
#define PIN_SEL9                 (*((volatile unsigned long *)0x4002C024))
#define PIN_SEL10                (*((volatile unsigned long *)0x4002C028))
#define PIN_MODE0                (*((volatile unsigned long *)0x4002C040))
#define PIN_MODE1                (*((volatile unsigned long *)0x4002C044))
#define PIN_MODE2                (*((volatile unsigned long *)0x4002C048))
#define PIN_MODE3                (*((volatile unsigned long *)0x4002C04C))
#define PIN_MODE4                (*((volatile unsigned long *)0x4002C050))
#define PIN_MODE5                (*((volatile unsigned long *)0x4002C054))
#define PIN_MODE6                (*((volatile unsigned long *)0x4002C058))
#define PIN_MODE7                (*((volatile unsigned long *)0x4002C05C))
#define PIN_MODE8                (*((volatile unsigned long *)0x4002C060))
#define PIN_MODE9                (*((volatile unsigned long *)0x4002C064))
#define PIN_MODE_OD0             (*((volatile unsigned long *)0x4002C068))
#define PIN_MODE_OD1             (*((volatile unsigned long *)0x4002C06C))
#define PIN_MODE_OD2             (*((volatile unsigned long *)0x4002C070))
#define PIN_MODE_OD3             (*((volatile unsigned long *)0x4002C074))
#define PIN_MODE_OD4             (*((volatile unsigned long *)0x4002C078))
#define I2CPADCFG               (*((volatile unsigned long *)0x4002C07C))

/*********************************************************************************************************
**  GPIO
*********************************************************************************************************/
#define FIO0DIR                 (*((volatile unsigned long *)0x2009c000))		//0		控制的引脚为输入,1	控制的引脚为输出
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
#define FIO0MASK                (*(volatile unsigned long *)0x2009c010)		//0		对应引脚正常,	1	对应的引脚不能够通过FIOPIN,FIOSET,FIOCLR访问
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
																			//不关心引脚配置为输入或输出,如果要使输出有些必须将相应引脚设置为输出模式
#define FIO0PIN                 (*(volatile unsigned long *)0x2009c014)		//0		控制的引脚输出被设置为低,1	控制的引脚输出被设置为高
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
#define FIO0SET                 (*(volatile unsigned long *)0x2009c018)		//0		控制的引脚输出不改变,1	控制的引脚输出被设置为高
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
#define FIO0CLR                 (*(volatile unsigned long *)0x2009c01c)		//0		控制的引脚输出不改变,1	控制的引脚输出被设置为低
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
#define IO0IntEnR               (*(volatile unsigned long *)0x40028090)		//上升沿的GPIO中断使能   0 上升沿中断禁能,	1  上升沿中断使能
#define IO2IntEnR               (*(volatile unsigned long *)0x400280B0)

#define IO0IntEnF               (*(volatile unsigned long *)0x40028094)		//下降沿的GPIO中断使能   0 下降沿中断禁能,	1  下降沿中断使能
#define IO2IntEnF               (*(volatile unsigned long *)0x400280B4)

#define IO0IntStatR             (*(volatile unsigned long *)0x40028084)		//上升沿的GPIO中断标志   0  对应引脚上没有上升沿中断,1  对应引脚上出现上升沿中断
#define IO2IntStatR             (*(volatile unsigned long *)0x400280A4)

#define IO0IntStatF             (*(volatile unsigned long *)0x40028088)		//下降沿的GPIO中断标志   0  对应引脚上没有下降沿中断,1  对应引脚上出现下降沿中断
#define IO2IntStatF             (*(volatile unsigned long *)0x400280A8)

#define IO0IntClr               (*(volatile unsigned long *)0x4002808C)		//GPIO中断标志清零
#define IO2IntClr               (*(volatile unsigned long *)0x400280AC)

#define IOIntStatus             (*(volatile unsigned long *)0x40028080)		//GPIO整体中断状态
																			//bit0   0  P0上没有挂起的中断		1   P0上至少有一个挂起的中断
																			//bit1	 保留
																			//bit2	 0  P2上没有挂起的中断		1   P2上至少有一个挂起的中断
																			//bit31~3  保留
...
#define U0DLL                   (*(volatile unsigned long *)0x4000C000) //除数锁存LSB                               
#define U0RBR                   (*(volatile unsigned long *)0x4000C000)	//接收器缓冲
#define U0THR                   (*(volatile unsigned long *)0x4000C000)	//发送器缓冲

#define U0IER                   (*(volatile unsigned long *)0x4000C004) /* U0DLM and U0IER              */ //中断使能
																		/* share the same address       */
#define U0DLM                   (*(volatile unsigned long *)0x4000C004) //除数锁存MSB                                 

#define U0FCR                   (*(volatile unsigned long *)0x4000C008) /* U0FCR and U0IIR              */  //FIFO控制
																		/* share the same address       */
#define U0IIR                   (*(volatile unsigned long *)0x4000C008) //中断ID                                  

#define U0LCR                   (*(volatile unsigned long *)0x4000C00C)	//线控制
#define U0LSR                   (*(volatile unsigned long *)0x4000C014)	//线状态
#define U0SCR                   (*(volatile unsigned long *)0x4000C01C)	//高速缓存
#define U0ACR                   (*(volatile unsigned long *)0x4000C020)	//自动波特率控制
#define U0FDR                   (*(volatile unsigned long *)0x4000C028)	//小数分频器
#define U0TER                   (*(volatile unsigned long *)0x4000C030)	//发送使能
#define U0FIFOLVL               (*(volatile unsigned long *)0x4000C058)	//FIFO状态寄存器
...
#define U1RBRTHR                (*(volatile unsigned long *)0x40010000) /* U1DLL, U1RBR and U1THR       */
																		/* share the same address       */
#define U1DLL                   (*(volatile unsigned long *)0x40010000)                               
#define U1RBR                   (*(volatile unsigned long *)0x40010000)
#define U1THR                   (*(volatile unsigned long *)0x40010000)

#define U1IER                   (*(volatile unsigned long *)0x40010004) /* U1DLM and U1IER              */
																		/* share the same address       */
#define U1DLM                   (*(volatile unsigned long *)0x40010004)                                   
...
#define U2RBRTHR                (*(volatile unsigned long *)0x40098000) /* U2DLL, U2RBR and U2THR       */
																		/* share the same address       */
#define U2DLL                   (*(volatile unsigned long *)0x40098000)                               
#define U2RBR                   (*(volatile unsigned long *)0x40098000)
#define U2THR                   (*(volatile unsigned long *)0x40098000)

#define U2IER                   (*(volatile unsigned long *)0x40098004) /* U2DLM and U2IER              */
																		/* share the same address       */
#define U2DLM                   (*(volatile unsigned long *)0x40098004)                                  
...
#define U3RBRTHR                (*(volatile unsigned long *)0x4009C000) /* U3DLL, U3RBR and U3THR       */
																		/* share the same address       */
#define U3DLL                   (*(volatile unsigned long *)0x4009C000)                                
#define U3RBR                   (*(volatile unsigned long *)0x4009C000)
#define U3THR                   (*(volatile unsigned long *)0x4009C000)

#define U3IER                   (*(volatile unsigned long *)0x4009C004) /* U3DLM and U3IER              */
																		/* share the same address       */
#define U3DLM                   (*(volatile unsigned long *)0x4009C004)                                 
...
**  D/A Converter
*********************************************************************************************************/
#define DA0CR                    (*(volatile unsigned long *)0x4008C000)
