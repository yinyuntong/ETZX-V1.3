...
1711                     ; 387 			IrDi_send_data(TxBuf,4,IR_MODE_NORMAL);
...
1723                     ; 390 			if ((inc%2)==0) {SetLed(1);} else {SetLed(0);}
...
1826                     ; 414 		if (i>120) {i--;SetLEDMode(0);}
...
1976  05de               L575:
1977                     ; 441 	TxBuf[1]=251;  //移动分机的房号固定251           
1979  05de 35fb002e      	mov	_TxBuf+1,#251
1980                     ; 442 	TxBuf[2]=num_2;
1982  05e2 450f2f        	mov	_TxBuf+2,_num_2
1983                     ; 443 	TxBuf[3]=0x10;
1985  05e5 35100030      	mov	_TxBuf+3,#16
1986                     ; 444 	if (RxBufBak[3]==7) TxBuf[3]=0x11;
