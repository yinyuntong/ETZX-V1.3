...
#define CMD_VOICE_MAINTAIN      0x98	//系统维护语音   SndSecAddr  0x01:开始播放   0X00:结束播放
#define CMD_VOICE_WAITE			0X99	//“请稍候，护士马上就来”语音  0x01:开始播放  0X00:结束播放
...
extern	bit		bLanding;
extern bit bPlayVoiceMaintain;
extern bit bPlayVoiceWait;
