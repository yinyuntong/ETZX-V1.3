...
#define 	BUS0_RX_Q_ZISE		(BUS0_FREQ_SIZE*10 + 1)		//单总线0数据接收队列长度
...
#define CMD_SET_NUMBER			0x5a	//编号命令
...
#define CMD_MAX_VOL_GET			0x93	//最大音量设置
...
extern bit bSecondDisState;										//秒钟闪烁标志
extern bit bSignflag;											//正负符号标志
...
//extern uint8 data byBus0RecData[];					//总线0接收缓冲区
