...
void InitParameter(void)
{
	...
	{	//没有初始化,初始化参数
		...
		stLocalControl.stEepromCfgData.bySelfSecAddr = MyNumber[0];
		stLocalControl.stEepromCfgData.bySelfRoomAddr = MyNumber[1];
		stLocalControl.stEepromCfgData.bySelfBedAddr = MyNumber[2];

		stLocalControl.stEepromCfgData.byReserve1 = MyNumber[3];
		stLocalControl.stEepromCfgData.byReserve2 = MyNumber[4];
		stLocalControl.stEepromCfgData.byReserve3 = MyNumber[5];

		stLocalControl.stEepromCfgData.byVersionHi = MyNumber[6];
		stLocalControl.stEepromCfgData.byVersionLo= MyNumber[7];		
		SaveParameter();
	}
}
...
//	Send_Data(byBus0SendData,7); 	//将接收到的数据发给PC机
