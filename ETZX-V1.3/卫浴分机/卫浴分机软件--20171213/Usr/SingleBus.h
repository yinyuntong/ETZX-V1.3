...
#ifndef _SINGLEBUS_H_
#define _SINGLEBUS_H_
...
#define CMD_NUMBER_SET			0x5a	/*修改编号命令*/		
#define CMD_SEC_SET				0x5b	/*设置系统区号*/
...
extern uint8 xdata bySec;
extern uint8 xdata byRoom;
...
extern bit bBus0SndBitOk;
extern bit bNumSeting;

extern void SingleBusInit(void); 	
extern void Bus0OutputData(uint8* pbyData);  
...
extern uint8 ParaCrcCheck(uint16 addr);
