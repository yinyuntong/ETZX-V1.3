...
#define	UART0_RX_BUF_SIZE	(200+EXT_SIZE)

#define UART0_TX_BUF_SIZE    (64+EXT_SIZE)
...
#define 	ITEM_CODE			0X0F
#define     ITEM_DATA_LEN		0X10
...
#define 	UsartSdingDieatData	0x01
#define 	UsartSdingPrescriptionData 0x02
#define 	UsartSdingPromptData 0x04
...
extern bit bUsartRecedDietData;
extern bit bUsartRecedPrescriptionData;
extern bit bUsartRecedPromptData;
extern bit bDispBedFace;
extern bit bDispBedForm;

extern STUsartCfg  xdata stUsartCfg;
extern uint8	xdata byUsart0RecBuf[];
extern uint8   xdata  byUsart0SndBuf[];

extern uint16 xdata uiBedFaceFormLen;
extern uint16 xdata uiBedFaceDataLen;

extern uint8 checkFormData(int16 datalen);
extern uint8 checkFaceData(int16 datalen);
extern void SectorDataCopy(unsigned long dst,unsigned long src,uint16 length);
extern uint8 IsSingleItem(uint8 *startaddr,uint8 length);
extern void UsartInit(void);
extern void UsartInitConfig(uint16 boudRate);
...
extern uint8 StoreDataCheck(unsigned long dst,uint16 length);
#endif