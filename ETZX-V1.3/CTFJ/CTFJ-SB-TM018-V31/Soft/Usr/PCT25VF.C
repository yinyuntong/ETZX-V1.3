...
//	delay_nms(25);
	...
	Byte_Write1(Dst,*p);		//解决写第一个字节写不进的问题
...
//	 Byte_Write(0x3d9000,FRAM_BUFF[0]);
//	 AAI_Write(0x3d9000,&(FRAM_BUFF[0]),10);
	 
	 for(i=0;i<20;i++) FRAM_BUFF[i]=0;
	 delay_nms(10);

//	 FRAM_BUFF[0]=Read(0x3d9000);
	 Read_Cont(&(FRAM_BUFF[0]),DIET_DATA_START_ADDR,10);
	 delay_nms(10);
