...
#define		TIMER0_COUNT		((65536-(Fbus*TIMER/12/10000)))		//TIMER以us为单位
...
#define CMD_RS485_BRT_SET		0X38	//485总线波特率设置
...
#define CMD_NUMBER_SET			0x5a	//修改房号床号命令
#define CMD_SYSTEM_SEC_SET		0x5b	//系统设号的设置
...
#define CMD_SB_LCD_DISPLAY_DATA 0X82	//手柄屏一帧数据

#define CMD_NURSE_IN			0X83	//护士到位命令
#define CMD_NURSE_OUT			0X84	//护士离开命令

#define CMD_HANDLER_REQUEST_SEND 0x85	//手柄请求发送数据
...
#define CMD_BUS0_CHECK			0xa4	//单总线0测试命令
...
#define CMD_BL_VOLTAGE_CHECK	0xac	//背光电压检测
