...
*********************************************************************************************************/
uint8_t eepromWrite(uint8_t * src_addr)
{
    uint8_t ucErr;
    ...
    ucErr = sectorPrepare(EEPROM_STARTSEC, EEPROM_ENDSEC);
    ucErr = ramCopy(EEPROM_STARTSEC*1024*4, (unsigned long)src_addr, 256);
    ucErr = dataCompare(EEPROM_STARTSEC*1024*4, (unsigned long)src_addr, 256);
                                                                        /*  比较数据                    */
